...
haha :: Expr -> Either TypeError Type
haha expr = case runInfer (infer expr) of
  Left err -> Left err
  Right s -> case runExcept (runStateT solve s) of
    Left err -> Left err
    Right (_, (t, _)) -> Right t
